                                ...
                                <div class="col-md-12">
                                    <form action="" id="create_account">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Placement</label>
                                                <select class="custom-select select form-control" name="placement"  >
                                            ...
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Graduate/Post Graduate</label>
                                                <select class="custom-select select form-control" name="graduate"  >
                                                    <option value="" disabled selected >Select</option>
