...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2022 at 07:31 AM
...
INSERT INTO `alumnus_bio` (`id`, `firstname`, `middlename`, `lastname`, `gender`, `batch`, `course_id`, `email`, `connected_to`, `avatar`, `status`, `date_created`, `salary`, `location`, `placement`, `graduate`) VALUES
(2, 'Mike', 'D', 'Williams', 'Male', 2009, 1, 'mwilliams@sample.com', 'My Company', '1602730260_avatar.jpg', 1, '2020-10-15', '', '', '', ''),
(9, 'Jayant', '', 'choraria', 'Male', 2021, 1, 'jayantchoraria4@gmail.com', 'none', '1651468680_my_profile.jpg', 0, '2022-05-02', '1234567', 'Work From Home', 'On Campus', 'Graduate');
...
(21, 'Jayant choraria', 'jayantchoraria4@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 3, '', 9);
